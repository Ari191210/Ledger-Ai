...
const TOOLS = [
  ...
  { n: "16", slug: "admissions",         ttl: "Admissions Engine",        sub: "Your real odds. 60 universities.",           desc: "GPA, test scores, ECs, awards → statistical admission probability for 60 top universities. AI strategy, gap analysis, essay angles, and deadline countdowns.",                                                                      gets: ["Probability at 60 real universities", "Safety / Match / Reach / Far Reach list", "AI strategy + essay angles + gap analysis"] },
  { n: "17", slug: "flashcards",         ttl: "AI Flashcards",            sub: "Topic or notes → flip cards.",               desc: "AI generates high-quality flashcards from any topic or your own notes. Track known/unknown per card and drill only what you haven't mastered.",                                                                                        gets: ["Paste your notes or name a topic", "Known / still-learning card tracking", "Flip to reveal, tap to categorise"] },
  { n: "18", slug: "essay-grader",       ttl: "Essay Grader",             sub: "Paste essay. Get examiner marks.",           desc: "Receive a grade, band score, and criteria-by-criteria feedback on argument, evidence, structure, and language — with specific improvement suggestions.",                                                                             gets: ["Grade + band score instantly", "4-criteria examiner breakdown", "Concrete improvement actions"] },
  { n: "19", slug: "personal-statement", ttl: "Personal Statement",       sub: "Score your application essay.",              desc: "1–10 holistic score, hook analysis, paragraph-by-paragraph feedback, tone check, and a rewritten opening sentence if yours isn't pulling weight.",                                                                               gets: ["Hook + structure + tone analysis", "Paragraph-by-paragraph notes", "Rewritten opening if yours is weak"] },
  { n: "20", slug: "interview",          ttl: "Interview Coach",          sub: "Practice. Get scored. Improve.",             desc: "Pick your interview type, answer AI-generated questions, then get scored with strengths, gaps, a model answer, and a coaching tip per response.",                                                                                   gets: ["University, Job, Medicine, Scholarship modes", "Score + model answer per question", "Coaching tip after every response"] },
  { n: "21", slug: "mindmap",            ttl: "Mind Map Builder",         sub: "Any topic. Full concept breakdown.",         desc: "AI generates a full collapsible mind map with depth levels. Branches collapse on click, colours by depth, printable to PDF in one click.",                                                                                        gets: ["Collapsible branch tree", "Brief / Standard / Deep dive modes", "Print to PDF in one click"] },
  { n: "22", slug: "citation",           ttl: "Citation Generator",       sub: "APA, MLA, Chicago, Harvard — instantly.",   desc: "Fill in source details and get a correctly formatted citation in any major style. Supports book, journal, website, newspaper, and video sources.",                                                                                gets: ["5 source types supported", "APA 7, MLA 9, Chicago 17, Harvard, Vancouver", "One-click copy to clipboard"] },
  { n: "23", slug: "presentation",       ttl: "Presentation Planner",     sub: "Topic → full slide deck with notes.",        desc: "AI builds a slide-by-slide presentation with speaker notes, calibrated to your audience, duration, and style. Left panel navigation, print-ready.",                                                                               gets: ["Slide panel + 16:9 preview", "Speaker notes for every slide", "Audience + duration + style controls"] },
  { n: "24", slug: "debate",             ttl: "Debate Coach",             sub: "Any motion. Arguments both ways.",           desc: "Generate for and against arguments, evidence, rebuttals, key terms, and practice questions for any debate motion at any level.",                                                                                                gets: ["3 arguments per side with evidence", "Rebuttal for each if challenged", "Key terms + practice questions"] },
  { n: "25", slug: "habits",             ttl: "Habit Tracker",            sub: "Build study habits that stick.",             desc: "Track daily study habits with a 14-day heatmap grid, per-habit streak counter, weekly score percentage, and the ability to add custom habits.",                                                                                gets: ["14-day heatmap history", "Streak counter per habit", "Add custom habits with emoji"] },
  { n: "26", slug: "deadlines",          ttl: "Deadline Hub",             sub: "Every deadline. Never miss one.",            desc: "Add exams, assignments, and applications with priority levels, categories, and notes. Overdue alerts, due-this-week counts, and category filters.",                                                                              gets: ["Countdown to each deadline", "Category + priority + overdue alerts", "Filter by type or status"] },
  { n: "27", slug: "exam-sim",           ttl: "Exam Simulator",           sub: "Timed AI exam. Full explanations.",          desc: "AI generates a realistic timed MCQ exam for any subject and level. Question map, flag-for-review, auto-submit, and full answer explanations after.",                                                                            gets: ["AI-generated timed MCQ exam", "Question map + flag for review", "Detailed explanation per question"] },
  { n: "28", slug: "gpa-sim",            ttl: "GPA Simulator",            sub: "Model your grades. Plan your GPA.",          desc: "Add all your courses, choose your scale (4.0 / 5.0 / 7.0 / 100), toggle weighted or unweighted, and find out what grade you need to hit a target GPA.",                                                                        gets: ["4.0 / 5.0 / 7.0 / 100 scale support", "Weighted vs unweighted toggle", "What-do-I-need? calculator"] },
  { n: "29", slug: "vocab",              ttl: "Vocabulary Vault",         sub: "Deep word learning with memory hooks.",      desc: "AI generates vocabulary sets with definition, part of speech, example sentence, etymology, synonyms, and a vivid memory hook. Card flip and list modes.",                                                                      gets: ["Memory hook per word", "Etymology + synonyms included", "Card flip + full list view"] },
  { n: "30", slug: "research",           ttl: "Research Assistant",       sub: "Any topic. Arguments, stats, angles.",      desc: "Full research briefing: sections, for/against arguments, real statistics, essay angles, and further reading — calibrated to your purpose and depth.",                                                                         gets: ["For + against arguments", "Statistics with sources", "5 essay angles to choose from"] },
  { n: "31", slug: "essay-blueprint",    ttl: "Essay Blueprint",          sub: "Topic → structure in three minutes.",        desc: "Paste any essay prompt and get a complete plan: thesis, paragraph-by-paragraph argument structure, evidence suggestions, and transitions — matched to your board's marking rubric.",                                           gets: ["Full thesis + argument structure", "Evidence suggestions per paragraph", "Board-matched writing guide"] },
  { n: "32", slug: "argument",           ttl: "Argument Builder",         sub: "Premise → steel-manned case.",              desc: "State a position. Get three structured arguments with evidence, anticipate the strongest counterarguments with steel-manned rebuttals, and receive a logical structure map for your essay.",                                   gets: ["3 arguments + evidence per side", "Steel-manned counterargument", "Logical structure map"] },
  { n: "33", slug: "coach",              ttl: "Academic Coach",           sub: "Personal guidance, any subject.",            desc: "Your AI mentor that knows your grade, board, and exam targets. Ask anything: how to study for Chemistry, how to fix your essay structure, how to stop avoiding Maths.",                                                       gets: ["Board + grade aware coaching", "Study strategy per subject", "Honest, specific advice"] },
  { n: "34", slug: "compare",            ttl: "Topic Comparer",           sub: "Two concepts. Side-by-side.",                desc: "Enter two topics, theories, or periods and get a structured comparison: similarities, differences, key tensions, and a recommendation for which angle suits an essay question best.",                                         gets: ["Structured similarity/difference table", "Key tension analysis", "Essay angle recommendation"] },
  { n: "35", slug: "concept-web",        ttl: "Concept Web",              sub: "Every connection in a chapter.",             desc: "Enter any topic and get a visual web showing every key idea, how they connect, and the hierarchy of understanding — ideal for revision before a detailed essay.",                                                             gets: ["Full concept relationship map", "Hierarchy of understanding", "Revision + essay prep"] },
  { n: "36", slug: "exam-planner",       ttl: "Exam Planner",             sub: "All your papers. One schedule.",             desc: "Add your exam subjects and dates. Get a day-by-day revision timetable weighted by proximity to exams, subject difficulty, and the hours you actually have.",                                                                gets: ["Day-by-day revision timetable", "Weighted by exam proximity + difficulty", "Hours-available input"] },
  { n: "37", slug: "lab-report",         ttl: "Lab Report Writer",        sub: "Hypothesis to discussion, complete.",        desc: "Enter your experiment, hypothesis, results table, and observations. Get a complete lab report with method, analysis, uncertainty calculations, and discussion in IGCSE/IB/CBSE format.",                                  gets: ["Full report in your board's format", "Uncertainty + error analysis", "Discussion + evaluation section"] },
  { n: "38", slug: "lang-analyzer",      ttl: "Language Analyzer",        sub: "Deep linguistic analysis of any text.",      desc: "Paste any passage for literary device identification, tone and register mapping, theme extraction, and a stylistic analysis matching your exam board's rubric expectations.",                                               gets: ["Literary devices identified + quoted", "Tone, register, theme analysis", "Exam rubric-matched commentary"] },
  { n: "39", slug: "mark-scheme",        ttl: "Mark Scheme Decoder",      sub: "Understand exactly how marks are won.",      desc: "Paste a mark scheme or question. Get an annotated breakdown of every mark point, what the examiner is signalling, and a checklist you can use to self-assess your answer.",                                               gets: ["Mark-point by mark-point breakdown", "Examiner intention explained", "Self-assessment checklist"] },
  { n: "40", slug: "paper-dissector",    ttl: "Paper Dissector",          sub: "Anatomy of a past paper.",                  desc: "Enter a past paper's subject and year. Get question-by-question difficulty ratings, topic frequency analysis, command word breakdown, and strategic advice for approaching it.",                                            gets: ["Topic frequency + difficulty map", "Command word analysis", "Strategic approach advice"] },
  { n: "41", slug: "practice",           ttl: "Practice Engine",          sub: "Targeted questions, any topic.",             desc: "Name any topic and level. Get 10 custom practice questions — MCQ, short answer, and extended — calibrated to your board's question style, with model answers for self-marking.",                                           gets: ["MCQ + short + extended questions", "Board-style question format", "Model answers included"] },
  { n: "42", slug: "source",             ttl: "Source Analyst",           sub: "OPCVL on any primary source.",               desc: "Paste any historical document or primary source. Get a complete OPCVL analysis — Origin, Purpose, Content, Value, and Limitation — structured for IB, IGCSE, and A-Level history marking.",                             gets: ["Full OPCVL breakdown", "IB / IGCSE / A-Level format", "Contextual background included"] },
  { n: "43", slug: "subject-picker",     ttl: "Subject Picker",           sub: "Choose your stream intelligently.",          desc: "Not sure which subjects to pick for Grade 11, IB, or A-Level? Enter your interests, strengths, and career direction for a ranked recommendation with detailed reasoning.",                                               gets: ["Ranked subject recommendations", "Reasoning per subject", "Career + entrance exam alignment"] },
  { n: "44", slug: "uni-match",          ttl: "University Matcher",       sub: "Find universities that fit you.",            desc: "Enter your grades, interests, budget, and location preferences. Get a ranked list of universities with course match, entry requirements, and application deadline countdowns.",                                           gets: ["Ranked by fit + entry grade match", "Course + location filters", "Deadline countdowns"] },
  { n: "45", slug: "predict",            ttl: "Question Predictor",       sub: "What will the examiner ask next?",           desc: "Enter your subject, topic, and exam board. Get 6-8 predicted questions ranked by likelihood, with reasoning, hot-topic areas, and command words likely to appear this cycle.",                                          gets: ["6–8 predicted questions ranked", "Likelihood reasoning per question", "Hot-topic + command word flags"] },
  { n: "46", slug: "memory-palace",      ttl: "Memory Palace Builder",    sub: "Remember anything with Method of Loci.",    desc: "Pick any list to memorise — vocabulary, dates, formulas, case studies. Get a full memory palace with a familiar location, vivid station images, and a memorable story linking every item.",                             gets: ["Full palace with location + stations", "Vivid image per item", "Story linking the whole sequence"] },
  { n: "47", slug: "analogy",            ttl: "Analogy Engine",           sub: "Turn complexity into understanding.",        desc: "Type any difficult concept and get 3 analogies ranked from most intuitive to most surprising, each with a breakdown of where the comparison holds and where it breaks down.",                                           gets: ["3 analogies: simple → surprising", "Breakdown of where each holds", "Limitation of each analogy"] },
  { n: "48", slug: "case-study",         ttl: "Case Study Pro",           sub: "Business scenarios, fully analysed.",        desc: "Enter a company, industry, or scenario. Get a complete business case study with SWOT, Porter's Five Forces, stakeholder map, and strategic recommendations in exam-ready format.",                                        gets: ["SWOT + Porter's 5 Forces analysis", "Stakeholder map + tensions", "Strategic recommendations"] },
  { n: "49", slug: "timeline",           ttl: "Timeline Builder",         sub: "History, chronologically mapped.",           desc: "Enter any historical period or topic. Get 10-14 key events with dates, significance, causal links between them, and category tags — formatted for history exam essay structure.",                                      gets: ["10–14 annotated events", "Causal links between events", "Political / Economic / Social categories"] },
  { n: "50", slug: "reading",            ttl: "Reading Companion",        sub: "Understand any passage deeply.",             desc: "Paste any unseen text. Get a summary, tone and theme analysis, key literary devices with examples, and 4 comprehension questions at different difficulty levels — all in one page.",                                    gets: ["Summary + tone + theme analysis", "Literary devices identified + quoted", "4-level comprehension questions"] },
  { n: "51", slug: "grammar",            ttl: "Grammar Coach",            sub: "Write with academic precision.",             desc: "Paste any piece of writing. Get a quality score, grammar and style issues by category, a list of strengths, a corrected rewrite, and 10 academic phrases to improve your register.",                                   gets: ["Overall quality score + issues by type", "Corrected rewrite of your text", "10 academic phrases to use"] },
  { n: "52", slug: "study-guide",        ttl: "Study Guide Builder",      sub: "Complete revision guide in minutes.",        desc: "Enter any topic or chapter. Get a full study guide: sections, must-know facts, common mistakes, exam tips, visual memory prompts, and a 60-second summary for last-minute review.",                                   gets: ["Structured sections with must-knows", "Common mistakes to avoid", "60-second last-minute summary"] },
  { n: "53", slug: "exam-strategy",      ttl: "Exam Strategy",            sub: "How to work the paper on exam day.",         desc: "Input your exam type, duration, and subject. Get time allocation per section, nerve-control techniques, last-minute revision priorities, and a personalised exam-day checklist.",                                     gets: ["Time allocation per section", "Nerve-control + focus techniques", "Personalised exam-day checklist"] },
  { n: "54", slug: "concept-connect",    ttl: "Concept Connect",          sub: "Bridge ideas across subjects.",              desc: "Enter two concepts from any discipline. Get structural, causal, analogical, and historical connections — uncovering surprising links between ideas you thought were unrelated.",                                       gets: ["Structural + causal connections", "Analogical + historical links", "Cross-subject insight map"] },
  { n: "55", slug: "model-answer",       ttl: "Model Answer Factory",     sub: "Produce full-marks exemplars.",              desc: "Paste any exam question. Get a model answer hitting every marking point, a structure guide showing how marks are distributed, and commentary on what makes this answer grade-band-A.",                               gets: ["Full-marks model answer", "Mark-point distribution map", "Commentary on why it works"] },
    ...
    <div>
      ...
      >
        ...
        <div className="mono lp-metabar">
          ...
          <span>Free to use · All 55 tools included</span>
        </div>
        ...
        <header className="lp-header">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 4 }}>
            ...
            <div className="mono" style={{ color: "var(--ink-3)" }}>Issue 55 · Tools · One Ledger</div>
          </div>
        ...
        <section className="lp-lede">
          <div>
            ...
            <div className="smc" style={{ marginTop: 18 }}>
              On the question of whether students actually need fifty-five different apps
            </div>
          </div>

          <div>
            <h2 className="lp-h2">
              55 tools. One ledger. Built for the student who would rather be studying than picking software.
            </h2>
            <p className="dropcap cols-2" style={{ marginTop: 28, fontSize: 17, lineHeight: 1.55 }}>
              The problem with student productivity is that it has been solved fifty-five times and none of the solutions talk to each other. Your planner does not know your marks. Your essay grader does not know your board. Your Pomodoro timer does not know you have a Chemistry practical on Thursday.{" "}
              <span className="mark">Ledger is the single book where all of it is entered, measured, and scheduled</span>{" "}
              — 55 tools sharing one calendar, one streak, one syllabus, and one real-time score that tells you exactly how exam-ready you are right now.
            </p>
          </div>
          ...
          <aside style={{ borderLeft: "1px solid var(--rule)", paddingLeft: 22 }}>
            ...
            <ol className="plain" style={{ marginTop: 12, fontFamily: "var(--sans)", fontSize: 13, lineHeight: 1.75, color: "var(--ink-2)" }}>
              <li><span className="mono">p.1</span>&nbsp; All 55 Tools</li>
        ...
        <section id="tools" className="lp-pad-t" style={{ borderBottom: "1px solid var(--ink)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 8, marginBottom: 28 }}>
            <div>
              <div className="mono cin">Section A — All 55 Tools</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 0, border: "1px solid var(--ink)" }}>
            {/* Tool list */}
            <div style={{ borderRight: "1px solid var(--ink)", maxHeight: 680, overflowY: "auto" }}>
              {TOOLS.map((t, i) => (
                <button
                  key={t.n}
        ...
        <footer className="lp-footer">
          ...
          {[
            { h: "Tools", l: ["Planner", "Marks Predictor", "Notes Simplifier", "Doubt Solver", "Essay Blueprint", "Essay Grader", "Argument Builder", "Grammar Coach", "Model Answer Factory", "Topic Tutor", "AI Flashcards", "Concept Web", "Vocabulary Vault", "Analogy Engine", "Memory Palace", "Past Papers", "Exam Simulator", "Practice Engine", "Question Predictor", "48-Hour Crunch", "Exam Strategy", "Focus Dashboard", "Habit Tracker", "Deadline Hub", "Research Assistant", "Paper Dissector", "Source Analyst", "Language Analyzer", "Mark Scheme Decoder", "Reading Companion", "Timeline Builder", "Case Study Pro", "Concept Connect", "Admissions Engine", "University Matcher", "Career Pathfinder", "Subject Picker", "Interview Coach", "Resume Builder", "Ledger Score™"] },
