...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      {
        q: "Is it really free?",
        a: "Yes. The Free tier is free forever — no credit card needed. You get 10 core tools and 20 AI requests per day. Pro (₹199/month) unlocks every tool and removes daily AI limits.",
      },
      {
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "64px 40px 96px" }}>
        ...
        <div style={{ marginTop: 64, padding: "32px 0", borderTop: "1px solid var(--rule)" }}>
          ...
          <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
            ...
            <Link href="/legal?section=privacy" style={{ fontFamily: "var(--mono)", fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--ink-3)", textDecoration: "none" }}>
              Privacy Policy
            </Link>
          </div>
        </div>
