    ...
    <div style={overlay}>
      <div className="mob-p" style={{ maxWidth: 620, margin: "0 auto", padding: "56px 24px 80px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 48 }}>
          ...
          <Link href="/home" className="mono" style={{ color: "var(--ink-3)", textDecoration: "none" }}>← exit</Link>
        </div>
  ...
  return (
    <div style={overlay}>
      <div className="mob-p" style={{ maxWidth: 620, margin: "0 auto", padding: "72px 24px 80px" }}>
        ...
        <Link href="/home" className="btn" style={{ display: "inline-block" }}>Close the laptop →</Link>
      </div>
    </div>
  );
}
