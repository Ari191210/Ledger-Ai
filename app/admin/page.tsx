        ...
        <div style={{ padding: "20px 0 16px", display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20, paddingBottom: 4 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div>
                <div style={{ fontFamily: "var(--mono)", fontSize: 8, color: isLive ? "#2d7a3c" : "#666", letterSpacing: "0.1em" }}>
                    ...
                    {stats.recent.map((ev, i) => (
                      <div key={i} style={{ display: "flex", gap: 10, padding: "9px 0", borderBottom: "1px solid #111" }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontFamily: "var(--mono)", fontSize: 7, color: "#555", marginTop: 3, letterSpacing: "0.04em" }}>
            ...
            <div style={{ border: "1px solid #111", borderTop: "none" }}>
              <div style={{ padding: "22px 32px", borderBottom: "1px solid #111" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  <div style={{ fontFamily: "var(--mono)", fontSize: 7, color: "#555" }}>Last 50 AI calls · all time</div>
                </div>
              </div>
