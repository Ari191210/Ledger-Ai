  ...
  return (
    <div className="mx-auto max-w-xl">
      ...
      <div className="mt-4 mb-3">
        ...
        <h1 className="mt-1 text-lg font-bold text-text">Crunch Mode</h1>
        <p className="u-mono mt-1 text-2xs text-text-3">
          built from your real open mistakes and uncovered syllabus, not invented
        </p>
      </div>
      <AiTool slug="crunch" fields={PROMPTS.crunch.fields} />
    </div>
  );
}
