      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
        <div ref={formRef} className="gl-pane-alt" style={{ width: "100%", maxWidth: 420, padding: "36px 32px", border: "1px solid var(--rule)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "20px 0" }}>
            ...
            <span style={{ fontFamily: "var(--mono)", fontSize: 9, letterSpacing: "0.1em", color: "var(--ink-3)", textTransform: "uppercase" }}>or</span>
            <div style={{ flex: 1, height: 1, background: "var(--rule)" }} />
          </div>
          ...
          <button
            ...
            style={{
              ...
              padding: "13px 0", background: "var(--paper-2)", border: "1px solid var(--rule)",
              cursor: "pointer", fontFamily: "var(--sans)", fontSize: 14, fontWeight: 500,
              color: "var(--ink)", boxShadow: "none", borderRadius: 0,
              transition: "border-color 150ms ease, background 150ms ease",
            }}
            onMouseOver={e => { e.currentTarget.style.borderColor = "var(--ink-3)"; e.currentTarget.style.background = "var(--paper)"; }}
            onMouseOut={e => { e.currentTarget.style.borderColor = "var(--rule)"; e.currentTarget.style.background = "var(--paper-2)"; }}
          >
            {/* Google G icon */}
