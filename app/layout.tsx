      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var p=localStorage.getItem('palette')||'ledger';var T={ledger:{p:'#08090c',p2:'#0f1016',i:'#f1ffc4',i2:'#dab894',i3:'#a7bed3',a:'#ffcaaf',am:'#e89a80',r:'rgba(167,190,211,0.20)',r2:'rgba(167,190,211,0.08)',ga:'rgba(255,202,175,0.20)',gb:'rgba(167,190,211,0.12)',h:'rgba(255,202,175,0.16)'},void:{p:'#000000',p2:'#0a0a0a',i:'#f0f0f8',i2:'#9090b0',i3:'#505070',a:'#a78bfa',am:'#7c3aed',r:'rgba(167,150,255,0.18)',r2:'rgba(167,150,255,0.07)',ga:'rgba(167,139,250,0.22)',gb:'rgba(124,58,237,0.10)',h:'rgba(167,139,250,0.18)'},dusk:{p:'#06070f',p2:'#090b18',i:'#e8ecf8',i2:'#8890b8',i3:'#606888',a:'#818cf8',am:'#6366f1',r:'rgba(130,140,248,0.20)',r2:'rgba(130,140,248,0.08)',ga:'rgba(129,140,248,0.20)',gb:'rgba(99,102,241,0.10)',h:'rgba(129,140,248,0.18)'},amber:{p:'#0e0a02',p2:'#120d03',i:'#fff8e6',i2:'#c8a060',i3:'#886840',a:'#fbbf24',am:'#d97706',r:'rgba(251,191,36,0.20)',r2:'rgba(251,191,36,0.08)',ga:'rgba(251,191,36,0.20)',gb:'rgba(217,119,6,0.10)',h:'rgba(251,191,36,0.16)'},rose:{p:'#100608',p2:'#18090c',i:'#f8eef2',i2:'#c08898',i3:'#806070',a:'#fb7185',am:'#e11d48',r:'rgba(251,113,133,0.20)',r2:'rgba(251,113,133,0.08)',ga:'rgba(251,113,133,0.20)',gb:'rgba(225,29,72,0.10)',h:'rgba(251,113,133,0.18)'},frost:{p:'#040a14',p2:'#070e1e',i:'#eef5ff',i2:'#90b8d8',i3:'#6090b0',a:'#38bdf8',am:'#0284c7',r:'rgba(56,189,248,0.20)',r2:'rgba(56,189,248,0.08)',ga:'rgba(56,189,248,0.20)',gb:'rgba(2,132,199,0.10)',h:'rgba(56,189,248,0.18)'},forest:{p:'#040e06',p2:'#071208',i:'#e8f5ea',i2:'#80c888',i3:'#507058',a:'#4ade80',am:'#16a34a',r:'rgba(74,222,128,0.18)',r2:'rgba(74,222,128,0.07)',ga:'rgba(74,222,128,0.18)',gb:'rgba(22,163,74,0.10)',h:'rgba(74,222,128,0.15)'},ember:{p:'#120400',p2:'#1a0600',i:'#fff0e8',i2:'#d08060',i3:'#906040',a:'#f97316',am:'#c2410c',r:'rgba(249,115,22,0.20)',r2:'rgba(249,115,22,0.08)',ga:'rgba(249,115,22,0.20)',gb:'rgba(194,65,12,0.10)',h:'rgba(249,115,22,0.16)'}};var t=T[p]||T.ledger;var r=document.documentElement;r.style.setProperty('--paper',t.p);r.style.setProperty('--paper-2',t.p2);r.style.setProperty('--ink',t.i);r.style.setProperty('--ink-2',t.i2);r.style.setProperty('--ink-3',t.i3);r.style.setProperty('--cinnabar-ink',t.a);r.style.setProperty('--cinnabar',t.am);r.style.setProperty('--rule',t.r);r.style.setProperty('--rule-2',t.r2);r.style.setProperty('--page-glow-a',t.ga);r.style.setProperty('--page-glow-b',t.gb);r.style.setProperty('--highlight',t.h);var d=localStorage.getItem('ledger-density');if(d&&d!=='default')r.dataset.density=d;}catch(e){}})();`,
          }}
        />
