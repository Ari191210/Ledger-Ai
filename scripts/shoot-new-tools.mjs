...
for (const slug of ["deadlines", "mistake-dna", "debt-meter"]) {
  await page.goto(`http://localhost:3000/tools/${slug}`, { waitUntil: "networkidle2" });
  await new Promise((r) => setTimeout(r, 300));
  await page.screenshot({ path: `${OUT}\\tool-${slug}.png`, fullPage: true });
