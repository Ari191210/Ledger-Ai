...
export const TOOLS_REGISTRY: ToolEntry[] = [
  ...
  { slug: "exam-triage",        title: "Exam Triage",            subtitle: "48h crunch + syllabus cremator.",       cat: "PRACTISE", keywords: ["triage","crunch","cremator","revision","priority","urgent","last","night","last-night"] },
  ...
  { slug: "post-exam",          title: "Post-Exam Analysis",     subtitle: "Mistake DNA + exam debrief.",           cat: "PRACTISE", keywords: ["post","exam","debrief","mistake","dna","review","analyse","strategy"] },
