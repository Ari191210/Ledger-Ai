        ...
        {options.map((o) => {
          ...
          return (
            <button
              ...
              className={cn(
                "rounded-md border px-3 py-1.5 text-xs font-semibold u-tap transition-[scale,background-color,border-color,color] duration-[420ms] ease-spring active:scale-[0.97] active:duration-[90ms] active:ease-out",
                on
