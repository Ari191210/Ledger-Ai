...
const TOOLS = [
  ...
  { n: "17", slug: "flashcards",       label: "Flashcards",  full: "AI Flashcards"           },
  { n: "18", slug: "essay-grader",     label: "Grader",      full: "Essay Grader"            },
  { n: "19", slug: "personal-statement", label: "P.S.",      full: "Personal Statement"      },
  { n: "20", slug: "interview",        label: "Interview",   full: "Interview Coach"         },
  { n: "21", slug: "mindmap",          label: "Mind Map",    full: "Mind Map Builder"        },
  { n: "22", slug: "citation",         label: "Citation",    full: "Citation Generator"      },
  { n: "23", slug: "presentation",     label: "Slides",      full: "Presentation Planner"    },
  { n: "24", slug: "debate",           label: "Debate",      full: "Debate Coach"            },
  { n: "25", slug: "habits",           label: "Habits",      full: "Habit Tracker"           },
  { n: "26", slug: "deadlines",        label: "Deadlines",   full: "Deadline Hub"            },
  { n: "27", slug: "exam-sim",         label: "Exam Sim",    full: "Exam Simulator"          },
  { n: "28", slug: "gpa-sim",          label: "GPA",         full: "GPA Simulator"           },
  { n: "29", slug: "vocab",            label: "Vocab",       full: "Vocabulary Vault"        },
  { n: "30", slug: "research",         label: "Research",    full: "Research Assistant"      },
];
